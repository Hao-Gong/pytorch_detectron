...
__C.TRAIN.SNAPSHOT_PREFIX = 'res101_faster_rcnn_series'
...
__C.model_cfg = edict()
__C.model_cfg.pretrained=False
__C.model_cfg.evaluate_step=10
__C.model_cfg.thresh=0.5
__C.model_cfg.nms_thresh=0.5

__C.datasets = edict()
__C.datasets.train_coco_data_path=None
__C.datasets.train_coco_set='train2017'
