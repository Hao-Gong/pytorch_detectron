...
class resnet_fpn(nn.Module):
  def __init__(self, cfg):
    ...
    # define rpn
    self.RCNN_rpn = _RPN_FPN(self.dout_base_model,cfg)
    self.RCNN_proposal_target = _ProposalTargetLayer(self.n_classes,cfg)

    self.RCNN_roi_align = ROIAlignAvg((self.cfg.POOLING_SIZE+1, self.cfg.POOLING_SIZE+1), -1, 0)
