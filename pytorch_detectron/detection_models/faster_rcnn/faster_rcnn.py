...
from ...base_functions.rpn.rpn import _RPN
from ...lib_c.model.roi_layers import ROIAlign, ROIPool,ROIAlignAvg
from ...base_functions.rpn.proposal_target_layer_faster_rcnn import _ProposalTargetLayer
from ...base_functions.utils.net_utils import _smooth_l1_loss, _crop_pool_layer, _affine_grid_gen, _affine_theta
from ...backbone_models.resnet.resnet import  resnetSelection

class resnet_faster_rcnn(nn.Module):
    def __init__(self, cfg):
        super(resnet_faster_rcnn, self).__init__()
        self.cfg=cfg
        ...
        # define rpn
        self.RCNN_rpn = _RPN(self.dout_base_model,self.cfg)
        ...
        self.RCNN_roi_align = ROIAlign((self.cfg.POOLING_SIZE, self.cfg.POOLING_SIZE), 1.0/16.0, 0)
